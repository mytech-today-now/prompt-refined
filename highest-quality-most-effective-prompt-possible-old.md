...
ORIGINAL PROMPT:
"""
Refactor the following prompt.  Reply back with a prompt in mardown format.  Don't omit anything.  refactor the prompt to be the best "C:\GitHub\prompt-refined\ai-feeder-prompt.md" prompt file that it can be.
